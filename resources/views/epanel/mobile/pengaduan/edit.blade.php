...
<div class="card">
    ...
    <div class="card body" style="padding: 10px;">
        ...
        <form method="post" action="{{route('pengaduan.update', $temp->id)}}" enctype="multipart/form-data" autocomplete="off">
            @csrf
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <!--    <input type="text" class="form-control" readonly="" value="{{$temp->nama}}">-->
                            <!--</div>-->
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="fileinput-new thumbnail" style="width: 500px; height: 295px;">
                                    <a href="{{asset($temp->foto)}}" data-lity><img id="blah" src="{{asset($temp->foto)}}" alt="....." style="width: 100%; height: 285px;" /></a>
                                </div> 
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="label">Persetujuan Data</label>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-md btn-warning"><i class="fa fa-check"></i> Simpan</button>
                    </div>
                </div>
            </div>
        </form>
